...
<body>
		...
		<div class="small-12 large-11 large-centered columns">
                ...
                <div class="row collapse our-collection-title hide-for-large-up">
                    ...
                    <div class="large-6 columns text-center">
                    	<a href="#look-book-responsive" class="view-look-book">VIEW LOOKBOOK</a>
                    </div>
                </div>
                ...
                <p>The collection’s palette of bright hues in lemon and pacific opal, representing the intense colors of the boardwalk are balanced by subdued but iridescent shades of whites and pinks, capturing the sand and shells of the beach. The shiny bars are mixed with delicate tear drop and vintage Swarovski crystals taking cues from the scaffolding, cables, and lights on the games and the rides that permeate the wooden walk.</p>
                
                <p>Sadly and ironically, Hurricane Sandy devastated most of the Seaside Heights boardwalk and Paige’s home – just miles from the boardwalk – a couple of months prior to the launch of the collection. Unexpectedly, the collection is now dedicated to the victims of the storm. Paige and Ashley are positive that the upbeat, festive designs will inspire the community to restore the boardwalk to the fun-loving character it once portrayed.</p>
    ...
    <div class="row hide-for-large-up" id="look-book-responsive">
    	<div class="large-12 columns">
            ...
            <ul class="lookbook-responsive"> 
                <li><a href="img/lookbook/lookbook-example.jpg" class="fancybox" data-fancybox-group="lookbook"><img src="http://placehold.it/120x120"></a></li>
                <li><a href="img/lookbook/lookbook-example.jpg" class="fancybox" data-fancybox-group="lookbook"><img src="http://placehold.it/120x120"></a></li>
                <li><a href="img/lookbook/lookbook-example.jpg" class="fancybox" data-fancybox-group="lookbook"><img src="http://placehold.it/120x120"></a></li>
                <li><a href="img/lookbook/lookbook-example.jpg" class="fancybox" data-fancybox-group="lookbook"><img src="http://placehold.it/120x120"></a></li>
                <li><a href="img/lookbook/lookbook-example.jpg" class="fancybox" data-fancybox-group="lookbook"><img src="http://placehold.it/120x120"></a></li>
    ...
    <div class="row show-for-large-up">
    	<div class="large-12 columns">
            ...
            <div class="row lookbook-carousel">
            	<div class="large-12 columns">
